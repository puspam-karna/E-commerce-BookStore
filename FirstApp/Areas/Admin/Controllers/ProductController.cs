    ...
    
{
        ...
        
    {
        ...
        public ProductController(IUnitOfWork unitOfWork, IWebHostEnvironment hostEnvironment)//constructor to retrieve data from database
        {
        ...
        {   
            if (ModelState.IsValid)
                //upload new image to folder and populate product imageurl
            {
